...
#include "../../Northrend/CrusadersColiseum/TrialOfTheCrusader/trial_of_the_crusader.h"
...
struct TW_boss_faction_championsAI : public ScriptedAI
{
    TW_boss_faction_championsAI(Creature* creature, uint32 aitype) : ScriptedAI(creature)
    {
    ...
    ///Ruben: Function added to test if we're heroic, as only then need we simulate a pvp trinket.
    inline bool IsHeroicMode(){
	return (instance->instance->GetSpawnMode() == RAID_DIFFICULTY_10MAN_HEROIC || instance->instance->GetSpawnMode() == RAID_DIFFICULTY_25MAN_HEROIC);
    }

    ///Ruben: Function added to test if under CC effects, was a trinket shouldn't be blown otherwise.
    inline bool IsCrowdControlled(){
	return	me->HasAuraType(SPELL_AURA_MOD_STUN)
    ...
    void UpdateAI(uint32 uiDiff) override
    {
        ...
        if (mAIType != AI_PET)
        {
	    ///Ruben: Only simulate trinkets on heroic mode
	    if( IsHeroicMode() ){
		///Ruben: Keep a separate timer for trinkets.
		if( trinket_timer > uiDiff )
			trinket_timer -= uiDiff;
		else
			trinket_timer = 0;
		if (CCTimer < uiDiff)
		{
			///Ruben: Simulate trinket only if not on cooldown and actually necessary.
			if(trinket_timer == 0 && IsCrowdControlled() ){
				RemoveCC();
				trinket_timer = 120000;
			}
			///Ruben: Have this be called more frequently to simulate an actual reaction time, you could say.
// 			CCTimer = 8000+rand()%2000;
			CCTimer = 500+rand()%1000;
		}
		else CCTimer -= uiDiff;
            }
        }
...
class TW_mob_toc_druid : public CreatureScript
{
public:
    TW_mob_toc_druid() : CreatureScript("TW_mob_toc_druid") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_druidAI (creature);
    }

    struct TW_mob_toc_druidAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_druidAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_HEALER) {}
        ...
        void UpdateAI(uint32 uiDiff) override
        {
            ...
            TW_boss_faction_championsAI::UpdateAI(uiDiff);
        }
    };
...
class TW_mob_toc_shaman : public CreatureScript
{
public:
    TW_mob_toc_shaman() : CreatureScript("TW_mob_toc_shaman") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_shamanAI (creature);
    }

    struct TW_mob_toc_shamanAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_shamanAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_HEALER) {}
...
class TW_mob_toc_paladin : public CreatureScript
{
public:
    TW_mob_toc_paladin() : CreatureScript("TW_mob_toc_paladin") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_paladinAI (creature);
    }

    struct TW_mob_toc_paladinAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_paladinAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_HEALER) {}
...
class TW_mob_toc_priest : public CreatureScript
{
public:
    TW_mob_toc_priest() : CreatureScript("TW_mob_toc_priest") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_priestAI (creature);
    }

    struct TW_mob_toc_priestAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_priestAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_HEALER) {}
...
class TW_mob_toc_shadow_priest : public CreatureScript
{
public:
    TW_mob_toc_shadow_priest() : CreatureScript("TW_mob_toc_shadow_priest") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_shadow_priestAI (creature);
    }

    struct TW_mob_toc_shadow_priestAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_shadow_priestAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_RANGED) {}
...
class TW_mob_toc_warlock : public CreatureScript
{
public:
    TW_mob_toc_warlock() : CreatureScript("TW_mob_toc_warlock") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_warlockAI (creature);
    }

    struct TW_mob_toc_warlockAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_warlockAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_RANGED), Summons(me) {}
...
class TW_mob_toc_mage : public CreatureScript
{
public:
    TW_mob_toc_mage() : CreatureScript("TW_mob_toc_mage") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_mageAI (creature);
    }

    struct TW_mob_toc_mageAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_mageAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_RANGED) {}
...
class TW_mob_toc_hunter : public CreatureScript
{
public:
    TW_mob_toc_hunter() : CreatureScript("TW_mob_toc_hunter") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_hunterAI (creature);
    }

    struct TW_mob_toc_hunterAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_hunterAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_RANGED), Summons(me) {}
...
class TW_mob_toc_boomkin : public CreatureScript
{
public:
    TW_mob_toc_boomkin() : CreatureScript("TW_mob_toc_boomkin") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_boomkinAI (creature);
    }

    struct TW_mob_toc_boomkinAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_boomkinAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_RANGED) {}
...
class TW_mob_toc_warrior : public CreatureScript
{
public:
    TW_mob_toc_warrior() : CreatureScript("TW_mob_toc_warrior") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_warriorAI (creature);
    }

    struct TW_mob_toc_warriorAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_warriorAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_MELEE) {}
        ...
        void UpdateAI(uint32 uiDiff) override
        {
            ...
            if (m_uiBladestormTimer <= uiDiff)
            {
                ...
                ///Ruben: DBM shows a 1:30 cooldown on bladestorm.
//                 m_uiBladestormTimer = urand(20*IN_MILLISECONDS, 30*IN_MILLISECONDS);
...
class TW_mob_toc_dk : public CreatureScript
{
public:
    TW_mob_toc_dk() : CreatureScript("TW_mob_toc_dk") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_dkAI (creature);
    }

    struct TW_mob_toc_dkAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_dkAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_MELEE) {}
...
class TW_mob_toc_rogue : public CreatureScript
{
public:
    TW_mob_toc_rogue() : CreatureScript("TW_mob_toc_rogue") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_rogueAI (creature);
    }

    struct TW_mob_toc_rogueAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_rogueAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_MELEE) {}
...
class TW_mob_toc_enh_shaman : public CreatureScript
{
public:
    TW_mob_toc_enh_shaman() : CreatureScript("TW_mob_toc_enh_shaman") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_enh_shamanAI (creature);
    }

    struct TW_mob_toc_enh_shamanAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_enh_shamanAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_MELEE), Summons(me) {}
...
class TW_mob_toc_retro_paladin : public CreatureScript
{
public:
    TW_mob_toc_retro_paladin() : CreatureScript("TW_mob_toc_retro_paladin") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_retro_paladinAI (creature);
    }

    struct TW_mob_toc_retro_paladinAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_retro_paladinAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_MELEE) {}
...
class TW_mob_toc_pet_warlock : public CreatureScript
{
public:
    TW_mob_toc_pet_warlock() : CreatureScript("TW_mob_toc_pet_warlock") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_pet_warlockAI (creature);
    }

    struct TW_mob_toc_pet_warlockAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_pet_warlockAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_PET) {}
...
class TW_mob_toc_pet_hunter : public CreatureScript
{
public:
    TW_mob_toc_pet_hunter() : CreatureScript("TW_mob_toc_pet_hunter") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new TW_mob_toc_pet_hunterAI (creature);
    }

    struct TW_mob_toc_pet_hunterAI : public TW_boss_faction_championsAI
    {
        TW_mob_toc_pet_hunterAI(Creature* creature) : TW_boss_faction_championsAI(creature, AI_PET) {}
...
{
    new TW_mob_toc_druid();
    new TW_mob_toc_shaman();
    new TW_mob_toc_paladin();
    new TW_mob_toc_priest();
    new TW_mob_toc_shadow_priest();
    new TW_mob_toc_mage();
    new TW_mob_toc_warlock();
    new TW_mob_toc_hunter();
    new TW_mob_toc_boomkin();
    new TW_mob_toc_warrior();
    new TW_mob_toc_dk();
    new TW_mob_toc_rogue();
    new TW_mob_toc_enh_shaman();
    new TW_mob_toc_retro_paladin();
    new TW_mob_toc_pet_warlock();
    new TW_mob_toc_pet_hunter();
}
