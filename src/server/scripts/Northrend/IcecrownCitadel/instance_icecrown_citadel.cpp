        ...
        struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
        {
            ...
            void OnUnitDeath(Unit* unit) override
            {
                ...
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_DARKFALLEN_BLOODKNIGHT:
                        ...
                        CrimsonHallKillCount++;
                        if (CrimsonHallKillCount < 4)
                            SaveToDB();
                        else if (CrimsonHallKillCount == 4) // If the kill count equals 4, it means we cleared the first group.
                        {
            ...
            void WriteSaveDataMore(std::ostringstream& data) override
            {
                data << HeroicAttempts << ' '
                    ...
                    << UpperSpireTeleporterActiveState << ' ' << CrimsonHallKillCount;
            }
